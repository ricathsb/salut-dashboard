...
>(({ className, ...props }, ref) => (
    <SwitchPrimitives.Root
        className={cn(
            ...
            "data-[state=checked]:bg-green-500 data-[state=checked]:border-green-500", // Aktif = hijau
            "data-[state=unchecked]:bg-black data-[state=unchecked]:border-black",     // Tidak aktif = hitam
            className
        )}
        {...props}
        ref={ref}
